...
**Spec:** `docs/specs/2026-07-11-steno10k-m1-u-web-ui-design.md` · **ADR:** `docs/adr/0001-m1-u-web-ui-deferrals.md`
...
- **Deferred per ADR-0001:** no prompts, no Telegram, no per-run stage/force controls — confirmed absent from Tasks 8/11.
